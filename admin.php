            ...
            <div id="user-linesTab" class="admin-tab-content">
                <div class="admin-panel">
                    ...
                    <div class="form-group" style="margin-bottom: 20px;">
                        ...
                        <select id="userLineFilterLine" class="custom-select form-control" style="max-width: 300px; display: inline-block; margin-left: 10px;">
            ...
            <div id="routingTab" class="admin-tab-content">
                <div class="admin-panel">
                    ...
                    <div class="form-group" style="margin-bottom: 20px;">
                        ...
                        <select id="routingMaHangSelect" class="custom-select form-control" style="max-width: 400px;">
